...
/**
 * Stub: en Android las fs tools no existen, así que nunca hay checkpoints.
 */
actual class CheckpointStore {
    ...
    actual suspend fun revert(sessionId: String, turnId: String): CheckpointRevertResult =
        CheckpointRevertResult(restored = emptyList(), errors = listOf("Checkpoints no disponibles en Android"))
